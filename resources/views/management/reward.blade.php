        ...
        <tr>
          ...
          <td class="time">
            ...
            if($start_second < 68400 && $end_second <=68400 && $end_second> 43200){
              ...
              if(36000 <= $start_second && $start_second < 68400 && ($end_second> 68400 || $end_second < 43200)){ $time1=68400 - $start_second; $time1_hours=floor($time1 / 3600); $time1_minutes=floor(($time1 / 60) % 60); $time1_seconds=$time1 % 60; echo (sprintf("%02d:%02d:%02d", $time1_hours, $time1_minutes, $time1_seconds)); } @endphp </td>
                  <!-- 平日19〜22時 -->
          <td>
            @php
            if($attendance->week !== '金' && $attendance->week !== '土'){
            if($start_second < 68400 && $start_second> 36000 && ($end_second > 79200 || $end_second < 28800)){ echo (sprintf("%02d:%02d:%02d", 03, 00, 00)); } if($start_second> 68400 && $start_second <= 79200 && $end_second> 79200){
